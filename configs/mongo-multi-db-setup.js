...
export default {
  ...
  // Connection 1
  {
    ...
    connectionName: "conn_abc", // Enter desired name
    // if a connection string options such as server/port/etc are ignored
    connectionString: "mongodb://<user>:<Password>@<mongo-sv1>:27017/admin",
  ...
  // Connection 2
  {
    mongo,
    getConnectionStringFromInlineParams,
    connectionName: "conn_xyz", // Enter desired name
    // if a connection string options such as server/port/etc are ignored
    connectionString: "mongodb://<user>:<Password>@<mongo-sv2:27017/admin",
